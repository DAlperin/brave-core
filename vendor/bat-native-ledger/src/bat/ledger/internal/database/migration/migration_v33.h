...
// Migration 33 removes the contribution processor field from the pending_contribution table.
// We'll resolve the processor at the time the pending contribution is being retried.
const char v33[] = R"(
